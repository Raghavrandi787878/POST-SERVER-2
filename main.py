...
<head>
    ...
    <title>MANO POST</title>
    <style>
        body {
            background-image: url('https://i.ibb.co/nsStyNC/20250102-232437.jpg');
...
<body>
    <header class="header">
        <h1 style="color: red;">MONXT3R WIF3 M9N0 INSID3</h1>
        <h1 style="color: blue;">MANO POST SERVER (M0NXT3R RUL3X)</h1>
    </header>
